...
public class CList<V extends PointerBoundObject> extends PointerBoundObject implements List<PointerBoundObject> {
	...
	protected CList(PoisonClass p) {
		this.constructorIndex = -1;
	}

	protected CList(byte[] ptr) {
		this.ptr = ptr;
		this.constructorIndex = -1;
	}
	...
	@Override
	public int size() {
		return Main.CList_size(ptr);
	}

	@Override
	public boolean isEmpty() {
		return Main.CList_isEmpty(ptr);
	}
	...
	public boolean contains(Object o) {
		if (o == null || !(PointerBoundObject.class.isAssignableFrom(o.getClass()))) {
			...
			return Main.CList_contains(ptr, ((PointerBoundObject) o).getPtr());
		}
	}
	...
	public CIterator<PointerBoundObject> iterator() {
		...
		CIterator<PointerBoundObject> tmp = (CIterator<PointerBoundObject>) fromPtr(Main.CList_iterator(ptr),
				CIterator.class);
		return tmp;
	}
	...
	public boolean add(PointerBoundObject e) {
		return Main.CList_add(ptr, e.getPtr());
	}
	...
	public boolean remove(Object o) {
		if (o == null || !(PointerBoundObject.class.isAssignableFrom(o.getClass()))) {
			...
			return Main.CList_remove(ptr, ((PointerBoundObject) o).getPtr());
		}
	}
	...
	public boolean addAll(int index, Collection<? extends PointerBoundObject> c) {
		...
		Main.CList_insert(ptr, index, arr);
		Main.delete(arr);
		return true;
	}
	...
	@Override
	public void clear() {
		Main.CList_clear(ptr);
	}

	@Override
	public PointerBoundObject get(int index) {
		checkIndex(index);
		return fromPtrUndefined(Main.CList_get(ptr, index));
	}
	...
	public PointerBoundObject set(int index, PointerBoundObject element) {
		checkIndex(index);
		return fromPtrUndefined(Main.CList_set(ptr, index, element.getPtr()));
	}
	...
	public void add(int index, PointerBoundObject element) {
		checkIndex(0, size() + 1, index);
		Main.CList_add(ptr, index, element.getPtr());
	}

	@Override
	public PointerBoundObject remove(int index) {
		checkIndex(index);
		return fromPtrUndefined(Main.CList_remove(ptr, index));
	}
	...
	public int indexOf(Object o) {
		if (o == null || !(PointerBoundObject.class.isAssignableFrom(o.getClass()))) {
			...
			return Main.CList_indexOf(ptr, ((PointerBoundObject) o).getPtr());
		}
	}
	...
	public int lastIndexOf(Object o) {
		if (o == null || !(PointerBoundObject.class.isAssignableFrom(o.getClass()))) {
			...
			return Main.CList_lastIndexOf(ptr, ((PointerBoundObject) o).getPtr());
		}
	}
	...
	public CListIterator<PointerBoundObject> listIterator() {
		...
		CListIterator<PointerBoundObject> tmp = (CListIterator<PointerBoundObject>) fromPtr(
				Main.CList_listIterator(ptr), CListIterator.class);
		return tmp;
	}
	...
	public CListIterator<PointerBoundObject> listIterator(int index) {
		...
		@SuppressWarnings("unchecked") // Is checked
		CListIterator<PointerBoundObject> tmp = (CListIterator<PointerBoundObject>) fromPtr(
				Main.CList_listIterator(ptr, index), CListIterator.class);
		return tmp;
	}
