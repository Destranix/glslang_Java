...
JNIEXPORT void JNICALL Java_Java_Main_TSymbolTable_1setVariableExtensions___3BLjava_lang_String_2I_3Ljava_lang_String_2
  (JNIEnv* env, jclass self, jbyteArray ptr, jstring name, jobjectArray extensions){
	JNI_METHOD_GUARD_ENTER
	int numExts = env->GetArrayLength(extensions);
	TSymbolTable* elem = $<TSymbolTable*>(env _$ ptr);
...
JNIEXPORT void JNICALL Java_Java_Main_TSymbolTable_1setVariableExtensions___3BLjava_lang_String_2Ljava_lang_String_2I_3Ljava_lang_String_2
