...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_TAllocation
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_TAllocation_1check
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_TAllocation_1checkAllocList
	(JNIEnv* env, jclass self, jbyteArray ptr){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT jlong JNICALL Java_com_destranix_glslang_Main_TAllocation_1allocationSize
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_TAllocation_1offsetAllocation
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_TPoolAllocator
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_TPoolAllocator_1push
  (JNIEnv* env, jclass self, jbyteArray ptr){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_TPoolAllocator_1pop
  (JNIEnv* env, jclass self, jbyteArray ptr){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_TPoolAllocator_1popAll
  (JNIEnv* env, jclass self, jbyteArray ptr){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_TPoolAllocator_1allocate
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocator__
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocatorByTPoolAllocator
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocator___3B
  (JNIEnv* env, jclass self, jbyteArray a){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1address
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1allocate___3BJ
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1allocate___3BJ_3B
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1deallocate
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1_1Charalloc
  (JNIEnv* env, jclass self, jbyteArray ptr, jlong n){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1construct
...
JNIEXPORT void JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1destroy
  (JNIEnv* env, jclass self, jbyteArray ptr, jbyteArray ref){
	JNI_METHOD_GUARD_ENTER
	void* refPtr = (env _$ ref);
...
JNIEXPORT jlong JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1max_1size___3B
  (JNIEnv* env, jclass self, jbyteArray ptr){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT jlong JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1max_1size___3BI
...
JNIEXPORT jbyteArray JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1getAllocator
  (JNIEnv* env, jclass self, jbyteArray ptr){
	JNI_METHOD_GUARD_ENTER
...
JNIEXPORT jboolean JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1operatorEqual
...
JNIEXPORT jboolean JNICALL Java_com_destranix_glslang_Main_pool_1allocator_1operatorNotEqual
  (JNIEnv* env, jclass self, jbyteArray ptr, jbyteArray rhs){
	JNI_METHOD_GUARD_ENTER
	return (*$<pool_allocator<void*>*>(env _$ ptr) != *$<pool_allocator<void*>*>(env _$ rhs));
	JNI_METHOD_GUARD_LEAVE
