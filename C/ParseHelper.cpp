...
JNIEXPORT void JNICALL Java_Java_Main_TParseContextBase_1setLineCallback
  (JNIEnv* env, jclass self, jbyteArray ptr, jobject callback){
	...
	std::function<void(JNIEnv*, int, int, bool, int, const char*)> tmp([callbackGlobalRef](JNIEnv* env, int i0, int i1, bool b0, int i2, const char* s0){
		jclass clazz = env->FindClass("Java/Main$Void_IntIntBooleanIntString");
...
JNIEXPORT void JNICALL Java_Java_Main_TParseContextBase_1setExtensionCallback
  (JNIEnv* env, jclass self, jbyteArray ptr, jobject callback){
	...
	std::function<void(JNIEnv*, int, const char*, const char*)> tmp([callbackGlobalRef](JNIEnv* env, int i0, const char* s0, const char* s1){
		jclass clazz = env->FindClass("Java/Main$Void_IntStringString");
...
JNIEXPORT void JNICALL Java_Java_Main_TParseContextBase_1setVersionCallback
  (JNIEnv* env, jclass self, jbyteArray ptr, jobject callback){
	...
	std::function<void(JNIEnv*, int, int, const char*)> tmp([callbackGlobalRef](JNIEnv* env, int i0, int i1, const char* s0){
		jclass clazz = env->FindClass("Java/Main$Void_IntIntString");
...
JNIEXPORT void JNICALL Java_Java_Main_TParseContextBase_1setPragmaCallback
  (JNIEnv* env, jclass self, jbyteArray ptr, jobject callback){
	...
	std::function<void(JNIEnv*, int, const TVector<TString>&)> tmp([callbackGlobalRef](JNIEnv* env, int i0, const TVector<TString>& s0){
		jclass clazz = env->FindClass("Java/Main$Void_IntStringarray");
...
JNIEXPORT void JNICALL Java_Java_Main_TParseContextBase_1setErrorCallback
  (JNIEnv* env, jclass self, jbyteArray ptr, jobject callback){
	...
	std::function<void(JNIEnv*, int, const char*)> tmp([callbackGlobalRef](JNIEnv* env, int i0, const char* s0){
		jclass clazz = env->FindClass("Java/Main$Void_IntString");
...
JNIEXPORT void JNICALL Java_Java_Main_TParseContext_1setDefaultPrecision___3BI
  (JNIEnv* env, jclass self, jbyteArray ptr, jintArray v){
	JNI_METHOD_GUARD_ENTER
